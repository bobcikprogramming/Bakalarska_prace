...
@Database(entities = {TransactionEntity.class, TransactionHistoryEntity.class, PhotoEntity.class, ModeEntity.class, OwnedCryptoEntity.class, PDFEntity.class}, version = 1)
