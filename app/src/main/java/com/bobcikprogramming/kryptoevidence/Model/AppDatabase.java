...
@Database(entities = {TransactionEntity.class, TransactionHistoryEntity.class, PhotoEntity.class, ModeEntity.class, OwnedCryptoEntity.class, PDFEntity.class, ExchangeByYearEntity.class, DataVersion.class}, version = 1)
